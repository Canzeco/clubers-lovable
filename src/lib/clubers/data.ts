...
export const SEED_LISTINGS: Listing[] = [
  ...
  // ── Micro-apps ────────────────────────────────────────────
  {
    id: "app-face-aesthetic",
    name: "FaceLab · Aesthetic review",
    category: "app", subcategory: "Face analysis",
    participation: "partner",
    zone: "In-app", priceLevel: 1,
    clubersRating: 4.7, googleRating: 0,
    vibes: ["selfie", "AI", "beauty"],
    cover: photo("1544005313-94ddf0286df2", 300),
    gallery: [], openNow: true, hours: "Always",
    walkMin: 0,
    description: "Take three selfies and get a private report on facial proportions, symmetry and aesthetic suggestions from board-certified surgeons.",
    appKind: "Face analysis",
    developer: "FaceLab Studio",
    installs: 18400,
  ...
  {
    id: "app-voice-coach",
    name: "Tono · Voice coach",
    category: "app", subcategory: "Voice training",
    participation: "listed",
    zone: "In-app", priceLevel: 1,
    clubersRating: 4.5, googleRating: 0,
    vibes: ["audio", "AI", "coaching"],
    cover: photo("1478737270239-2f02b77fc618", 301),
    gallery: [], openNow: true, hours: "Always",
    walkMin: 0,
    description: "Record a 30-second sample and get pitch, pace and clarity feedback. Daily drills delivered to your phone.",
    appKind: "Voice coach",
    developer: "Tono Labs",
    installs: 6200,
  ...
  {
    id: "app-style-fit",
    name: "StyleFit · Color & fit",
    category: "app", subcategory: "Style analysis",
    participation: "partner",
    zone: "In-app", priceLevel: 1,
    clubersRating: 4.6, googleRating: 0,
    vibes: ["fashion", "AI", "wardrobe"],
    cover: photo("1483985988355-763728e1935b", 302),
    gallery: [], openNow: true, hours: "Always",
    walkMin: 0,
    description: "Scan your skin tone and body shape — get a seasonal color palette and silhouette guide tailored to you.",
    appKind: "Style analysis",
    developer: "StyleFit",
    installs: 9100,
...
export const t = {
  ...
  discover: {
    ...
    cats: { place: "Places", event: "Events", community: "Communities", person: "People", product: "Products", service: "Services", app: "Apps" },
