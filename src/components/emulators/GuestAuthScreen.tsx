      ...
      <div className="flex flex-1 flex-col justify-center px-6 pb-8">
        ...
        <div className="space-y-2">
          <button
            ...
            className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-border bg-card text-sm font-medium text-foreground transition disabled:opacity-60"
          >
